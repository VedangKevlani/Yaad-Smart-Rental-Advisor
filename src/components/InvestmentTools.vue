    ...
    <div class="container tool-box-container">
        ...
        <div class="tool-container">
            ...
            <div class="tool-box" v-show="showLoan">
                ...
                <input type="text" class="tool-input" :value="formattedLoanAmount" @input="updateLoanAmount($event.target.value)" placeholder="Enter Loan Amount ($)"/>
            ...
            <div class="tool-box" v-show="showInvestment">
                ...
                <input type="text" class="tool-input" :value="formattedInvestmentAmount" @input="updateInvestmentAmount($event.target.value)" placeholder="Enter Investment Amount($)" />
            ...
            <div class="tool-box" v-show="showRentVsBuy">
                ...
                <input type="text" class="tool-input" :value="formattedMonthlyRent" @input="updateMonthlyRent($event.target.value)" placeholder="Monthly Rent ($)"/>
                <input type="text" class="tool-input"  :value="formattedHomePrice" @input="updateHomePrice($event.target.value)" placeholder="Home Price ($)"/>
            ...
            <div class="tool-box" v-show="showRentalYield">
                ...
                <input type="text" class="tool-input" :value="formattedAnnualRentalIncome" @input="updateAnnualRentalIncome($event.target.value)" placeholder="Annual Rental Income ($)"/>
                <input type="text" class="tool-input"  :value="formattedPropertyCost" @input="updatePropertyCost($event.target.value)" placeholder="Property Purchase Price ($)"/>
            ...
            <div class="tool-box" v-show="showCashFlow">
                ...
                <input type="text" class="tool-input"  :value="formattedRentalIncome" @input="updateRentalIncome($event.target.value)" placeholder="Monthly Rental Income ($)"/>
                <input type="text" class="tool-input"  :value="formattedMonthlyExpenses" @input="updateMonthlyExpenses($event.target.value)" placeholder="Total Monthly Expenses ($)"/>
