      ...
      <section class="hero">
        <div class="hero-content">
          <transition name="fade">
            <div v-if="showWelcome" :class="['alert', isDarkmode ? 'alert-dark' : 'alert-info']">
      Welcome back, {{ displayName }}!
    </div>
  </transition>
          <div class="logo-title fade-in">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#40a7c3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="home-icon">
              <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
              <polyline points="9 22 9 12 15 12 15 22"></polyline>
            </svg>
            <h1 class="title">Yaad: <span class="highlight">Smart Property Advisor</span></h1>
          </div>
            ...
            <div class="form-group">
              <label for="address">
                <div class="label-with-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#40a7c3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <section class="how-it-works">
        ...
        <div class="steps-container">
          <div class="step fade-in">
            ...
            <p class="step-description">Fill in the address and basic property information to get started.</p>
          </div>
          ...
          <div class="step fade-in" style="animation-delay: 0.2s;">
            ...
            <p class="step-description">Our algorithms evaluate the property against market data and investment metrics.</p>
          </div>
          ...
          <div class="step fade-in" style="animation-delay: 0.4s;">
            ...
            <p class="step-description">Receive a detailed analysis of the property's investment potential.</p>
          </div>
        </div>
      </section>
